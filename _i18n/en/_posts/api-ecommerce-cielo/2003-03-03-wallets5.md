...
1. **CAVV** - pode ser extraido do campo `onlinePaymentCryptogram` retornado pela Apple no payload
2. **ECI** - pode ser extraido do campo `eciIndicator` retornado pela Apple no payload
