...
2. **PAN Sending** - When the merchant decrypts the information received from the Wallet and sends the PAN and CAVV/ECI codes to Cielo
...
| Fields                     | Type   | Size | Mandatory? | Description                                                                                               |
|----------------------------|--------|---------|-------------|---------------------------------------------------------------------------------------------------------|
